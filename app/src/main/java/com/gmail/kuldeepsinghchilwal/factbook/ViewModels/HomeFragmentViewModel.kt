...
fun alarmSet(isChecked: Boolean) {
    if(isChecked) {
        Log.i(" daily notification","notification: enabled")
        // Set the alarm to start at approximately  a.m.
...
// constants--in this case, AlarmManager.INTERVAL_DAY.
        ...
        Log.i("daily notification", "notification disabled")
        Toast.makeText(app, "Notification Disabled", Toast.LENGTH_SHORT).show()
        alarmMgr.cancel(notifyPendingIntent)
    }
}

    fun randomIdGenerator() {
        val categoryArray = arrayOf<String>(
            "car", "solarsystem", "cat", "dog", "smartphone",
