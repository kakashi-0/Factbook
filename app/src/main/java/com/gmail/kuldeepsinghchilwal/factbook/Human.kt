...
class Human : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (viewModel.humanResourceId != 0){
            binding.humanTextview.setText(getText(viewModel.humanResourceId))
        }
        ...
        //if its it's initial oncreate it'll generate new resource to be displayed at welcome screen
            ...
            viewModel.humanResourceId = resources.getIdentifier(humanIdGenerator(), "string", context?.packageName)
            binding.humanTextview.setText(getText(viewModel.humanResourceId))
        }
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.humanNext.setOnClickListener {
            ...
            viewModel.humanResourceId = humanResId
